...
uses GSM8K because the purpose is to verify the Megatron model path, vLLM
...
| Model | Script | Megatron topology | vLLM topology |
| --- | --- | --- | --- |
