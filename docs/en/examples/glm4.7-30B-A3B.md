...
Here, we will briefly introduce the key parts in the [run-glm4.7-30B-A3B.sh](https://github.com/vllm-project/vime/blob/main/scripts/run-glm4.7-30B-A3B.sh) script.
