...
SkyRL 已经在用 `/v1/chat/completions/render`（[remote_inference_client.py:768](projects/slime-vllm-backend-refactor/SkyRL/skyrl/backends/skyrl_train/inference_servers/remote_inference_client.py#L768)）——这是 disagg MM 的标配 entry。
