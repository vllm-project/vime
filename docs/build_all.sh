...
echo "[vime-docs] Building EN..."
./build.sh en
echo "[vime-docs] Building ZH..."
./build.sh zh
...
echo "[vime-docs] Done. Root landing page at build/index.html"