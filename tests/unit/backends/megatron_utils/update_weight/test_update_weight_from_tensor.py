...
def _install_stubs():
    ...
    torch_patch_mod = types.ModuleType("slime.backends.megatron_utils.update_weight.torch_patch")
    torch_patch_mod.monkey_patch_torch_reductions = MagicMock()
    sys.modules.setdefault("slime.backends.megatron_utils.update_weight.torch_patch", torch_patch_mod)
