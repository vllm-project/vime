...
def generate_rollout(args, rollout_id, data_source, evaluation: bool = False):
    ...
    # Default-shape rollouts leave rollout_id=None and vime falls back to
    # sample.index in vime/ray/rollout.py (the dp-schedule grouping key).
