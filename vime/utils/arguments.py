    ...
    def add_vime_arguments(parser):
        ...
        def add_train_arguments(parser):
            ...
            parser.add_argument(
                ...
                default="full",
                help=(
                    "Weight sync strategy. 'full' sends all weights over the selected "
                    "transport. 'delta' publishes only changed weight bytes "
            ...
            parser.add_argument(
                ...
                default=None,
                help=(
                    "Optional trainer-side hook after a disk version is written. Signature: "
...
def vime_validate_args(args):
    ...
    if args.update_weight_mode == "delta":
        ...
        if args.colocate:
            raise ValueError(
                "--update-weight-mode=full --update-weight-transport=disk is not supported with --colocate."
            )
        if not args.update_weight_disk_dir:
