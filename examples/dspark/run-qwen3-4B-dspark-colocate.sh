...
# DSpark speculative decoding training — colocate mode (8 GPUs)
#
...
#
# Usage: bash examples/dspark/run-qwen3-4B-dspark-colocate.sh
...
SAVE_DIR=${SAVE_DIR:-/root/Qwen3-4B_dspark_colocate/}
